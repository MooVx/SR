...
#
# Generated by export_simulation on Sat Jun 02 00:21:46 +0200 2018
#
################################################################################
...
'-reset_run' switch to the './delay_0.sh' script.

./delay_0.sh -reset_run
...
./delay_0.sh -noclean_files

For more information on the script, please type './delay_0.sh -help'.
