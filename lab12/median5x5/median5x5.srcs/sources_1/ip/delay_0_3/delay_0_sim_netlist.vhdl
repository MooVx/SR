...
--               c:/git/SR/lab12/median5x5/median5x5.srcs/sources_1/ip/delay_0_3/delay_0_sim_netlist.vhdl
-- Design      : delay_0
...
\(null)[1].(null)[0].reg_i_j\: entity work.delay_0_delay_block_2
     port map (
      clk => clk,
      odata(0) => odata(0),
      val => val
    );
\(null)[1].(null)[1].reg_i_j\: entity work.delay_0_delay_block_3
     port map (
      clk => clk,
      odata(0) => odata(1),
      val_reg_0 => \(null)[0].(null)[1].reg_i_j_n_0\
    );
\(null)[1].(null)[2].reg_i_j\: entity work.delay_0_delay_block_4
     port map (
      clk => clk,
      odata(0) => odata(2),
      val_reg_0 => \(null)[0].(null)[2].reg_i_j_n_0\
