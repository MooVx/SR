...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_delay_block_11 is
  signal NLW_val_reg_srl17_Q31_UNCONNECTED : STD_LOGIC;
  attribute srl_bus_name : string;
  attribute srl_bus_name of val_reg_srl17 : label is "\inst/(null)[81].(null) ";
  attribute srl_name : string;
  attribute srl_name of val_reg_srl17 : label is "\inst/(null)[81].(null)[0].reg_i_j/val_reg_srl17 ";
begin
val_reg_srl17: unisim.vcomponents.SRLC32E
    generic map(
      INIT => X"00000000"
    )
        port map (
      ...
      D => val_reg_0,
      Q => val_reg,
      Q31 => NLW_val_reg_srl17_Q31_UNCONNECTED
    );
end STRUCTURE;
library IEEE;
use IEEE.STD_LOGIC_1164.ALL;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_delay_block_12 is
  ...
  attribute srl_bus_name of val_reg_srl17 : label is "\inst/(null)[81].(null) ";
  attribute srl_name : string;
  attribute srl_name of val_reg_srl17 : label is "\inst/(null)[81].(null)[1].reg_i_j/val_reg_srl17 ";
begin
val_reg_srl17: unisim.vcomponents.SRLC32E
    generic map(
      INIT => X"00000000"
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_delay_block_13 is
  ...
  attribute srl_bus_name of val_reg_srl17 : label is "\inst/(null)[81].(null) ";
  attribute srl_name : string;
  attribute srl_name of val_reg_srl17 : label is "\inst/(null)[81].(null)[2].reg_i_j/val_reg_srl17 ";
begin
val_reg_srl17: unisim.vcomponents.SRLC32E
    generic map(
      INIT => X"00000000"
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_delay_block_14 is
  ...
  attribute srl_bus_name of val_reg_srl17 : label is "\inst/(null)[81].(null) ";
  attribute srl_name : string;
  attribute srl_name of val_reg_srl17 : label is "\inst/(null)[81].(null)[3].reg_i_j/val_reg_srl17 ";
begin
val_reg_srl17: unisim.vcomponents.SRLC32E
    generic map(
      INIT => X"00000000"
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_delay is
  ...
  signal \(null)[81].(null)[0].reg_i_j_n_0\ : STD_LOGIC;
  signal \(null)[81].(null)[1].reg_i_j_n_0\ : STD_LOGIC;
  signal \(null)[81].(null)[2].reg_i_j_n_0\ : STD_LOGIC;
  signal \(null)[81].(null)[3].reg_i_j_n_0\ : STD_LOGIC;
begin
...
\(null)[32].(null)[0].reg_i_j\: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_delay_block_3
     port map (
      clk => clk,
      val_reg => \(null)[32].(null)[0].reg_i_j_n_0\,
      val_reg_0 => \(null)[0].(null)[0].reg_i_j_n_0\
    );
\(null)[32].(null)[1].reg_i_j\: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_delay_block_4
     port map (
      clk => clk,
      val_reg => \(null)[32].(null)[1].reg_i_j_n_0\,
      val_reg_0 => \(null)[0].(null)[1].reg_i_j_n_0\
    );
\(null)[32].(null)[2].reg_i_j\: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_delay_block_5
     port map (
      clk => clk,
      val_reg => \(null)[32].(null)[2].reg_i_j_n_0\,
      val_reg_0 => \(null)[0].(null)[2].reg_i_j_n_0\
    );
\(null)[32].(null)[3].reg_i_j\: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_delay_block_6
     port map (
      clk => clk,
      val_reg => \(null)[32].(null)[3].reg_i_j_n_0\,
      val_reg_0 => \(null)[0].(null)[3].reg_i_j_n_0\
    );
\(null)[64].(null)[0].reg_i_j\: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_delay_block_7
     port map (
      clk => clk,
      val_reg => \(null)[64].(null)[0].reg_i_j_n_0\,
      val_reg_0 => \(null)[32].(null)[0].reg_i_j_n_0\
    );
\(null)[64].(null)[1].reg_i_j\: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_delay_block_8
     port map (
      clk => clk,
      val_reg => \(null)[64].(null)[1].reg_i_j_n_0\,
      val_reg_0 => \(null)[32].(null)[1].reg_i_j_n_0\
    );
\(null)[64].(null)[2].reg_i_j\: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_delay_block_9
     port map (
      clk => clk,
      val_reg => \(null)[64].(null)[2].reg_i_j_n_0\,
      val_reg_0 => \(null)[32].(null)[2].reg_i_j_n_0\
    );
\(null)[64].(null)[3].reg_i_j\: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_delay_block_10
     port map (
      clk => clk,
      val_reg => \(null)[64].(null)[3].reg_i_j_n_0\,
      val_reg_0 => \(null)[32].(null)[3].reg_i_j_n_0\
    );
\(null)[81].(null)[0].reg_i_j\: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_delay_block_11
     port map (
      clk => clk,
      val_reg => \(null)[81].(null)[0].reg_i_j_n_0\,
      val_reg_0 => \(null)[64].(null)[0].reg_i_j_n_0\
    );
\(null)[81].(null)[1].reg_i_j\: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_delay_block_12
     port map (
      clk => clk,
      val_reg => \(null)[81].(null)[1].reg_i_j_n_0\,
      val_reg_0 => \(null)[64].(null)[1].reg_i_j_n_0\
    );
\(null)[81].(null)[2].reg_i_j\: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_delay_block_13
     port map (
      clk => clk,
      val_reg => \(null)[81].(null)[2].reg_i_j_n_0\,
      val_reg_0 => \(null)[64].(null)[2].reg_i_j_n_0\
    );
\(null)[81].(null)[3].reg_i_j\: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_delay_block_14
     port map (
      clk => clk,
      val_reg => \(null)[81].(null)[3].reg_i_j_n_0\,
      val_reg_0 => \(null)[64].(null)[3].reg_i_j_n_0\
    );
\(null)[82].(null)[0].reg_i_j\: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_delay_block_15
     port map (
      clk => clk,
      odata(0) => odata(0),
      val_reg_0 => \(null)[81].(null)[0].reg_i_j_n_0\
    );
\(null)[82].(null)[1].reg_i_j\: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_delay_block_16
     port map (
      clk => clk,
      odata(0) => odata(1),
      val_reg_0 => \(null)[81].(null)[1].reg_i_j_n_0\
    );
\(null)[82].(null)[2].reg_i_j\: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_delay_block_17
     port map (
      clk => clk,
      odata(0) => odata(2),
      val_reg_0 => \(null)[81].(null)[2].reg_i_j_n_0\
    );
\(null)[82].(null)[3].reg_i_j\: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_delay_block_18
     port map (
      clk => clk,
      odata(0) => odata(3),
      val_reg_0 => \(null)[81].(null)[3].reg_i_j_n_0\
    );
end STRUCTURE;
library IEEE;
use IEEE.STD_LOGIC_1164.ALL;
