...
\(null)[1].(null)[0].reg_i_j\: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_delay_block_2
     port map (
      clk => clk,
      odata(0) => odata(0),
      val => val
    );
\(null)[1].(null)[1].reg_i_j\: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_delay_block_3
     port map (
      clk => clk,
      odata(0) => odata(1),
      val_reg_0 => \(null)[0].(null)[1].reg_i_j_n_0\
    );
\(null)[1].(null)[2].reg_i_j\: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_delay_block_4
     port map (
      clk => clk,
      odata(0) => odata(2),
      val_reg_0 => \(null)[0].(null)[2].reg_i_j_n_0\
...
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_delay
     port map (
      clk => clk,
      idata(2 downto 0) => idata(2 downto 0),
      odata(2 downto 0) => odata(2 downto 0)
    );
end STRUCTURE;
