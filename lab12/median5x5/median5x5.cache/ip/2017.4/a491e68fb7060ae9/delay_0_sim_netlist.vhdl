...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_delay_block_18 is
  ...
  attribute srl_bus_name of val_reg_srl4 : label is "\inst/(null)[164].(null) ";
  attribute srl_name : string;
  attribute srl_name of val_reg_srl4 : label is "\inst/(null)[164].(null)[4].reg_i_j/val_reg_srl4 ";
begin
val_reg_srl4: unisim.vcomponents.SRLC32E
    generic map(
      INIT => X"00000000"
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_delay is
  ...
  signal \(null)[164].(null)[4].reg_i_j_n_0\ : STD_LOGIC;
...
\(null)[164].(null)[0].reg_i_j\: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_delay_block_14
     port map (
      clk => clk,
      val_reg => \(null)[164].(null)[0].reg_i_j_n_0\,
      val_reg_0 => \(null)[160].(null)[0].reg_i_j_n_0\
    );
\(null)[164].(null)[1].reg_i_j\: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_delay_block_15
     port map (
      clk => clk,
      val_reg => \(null)[164].(null)[1].reg_i_j_n_0\,
      val_reg_0 => \(null)[160].(null)[1].reg_i_j_n_0\
    );
\(null)[164].(null)[2].reg_i_j\: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_delay_block_16
     port map (
      clk => clk,
      val_reg => \(null)[164].(null)[2].reg_i_j_n_0\,
      val_reg_0 => \(null)[160].(null)[2].reg_i_j_n_0\
    );
\(null)[164].(null)[3].reg_i_j\: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_delay_block_17
     port map (
      clk => clk,
      val_reg => \(null)[164].(null)[3].reg_i_j_n_0\,
      val_reg_0 => \(null)[160].(null)[3].reg_i_j_n_0\
    );
\(null)[164].(null)[4].reg_i_j\: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_delay_block_18
     port map (
      clk => clk,
      val_reg => \(null)[164].(null)[4].reg_i_j_n_0\,
      val_reg_0 => \(null)[160].(null)[4].reg_i_j_n_0\
    );
\(null)[165].(null)[0].reg_i_j\: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_delay_block_19
     port map (
      clk => clk,
      odata(0) => odata(0),
      val_reg_0 => \(null)[164].(null)[0].reg_i_j_n_0\
    );
\(null)[165].(null)[1].reg_i_j\: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_delay_block_20
     port map (
      clk => clk,
      odata(0) => odata(1),
      val_reg_0 => \(null)[164].(null)[1].reg_i_j_n_0\
    );
\(null)[165].(null)[2].reg_i_j\: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_delay_block_21
     port map (
      clk => clk,
      odata(0) => odata(2),
      val_reg_0 => \(null)[164].(null)[2].reg_i_j_n_0\
    );
\(null)[165].(null)[3].reg_i_j\: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_delay_block_22
     port map (
      clk => clk,
      odata(0) => odata(3),
      val_reg_0 => \(null)[164].(null)[3].reg_i_j_n_0\
    );
\(null)[165].(null)[4].reg_i_j\: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_delay_block_23
     port map (
      clk => clk,
      odata(0) => odata(4),
      val_reg_0 => \(null)[164].(null)[4].reg_i_j_n_0\
    );
