...
#
# Generated by export_simulation on Wed May 23 23:44:18 +0200 2018
#
################################################################################
...
'-reset_run' switch to the './c_addsub_fin.sh' script.

./c_addsub_fin.sh -reset_run
...
./c_addsub_fin.sh -noclean_files

For more information on the script, please type './c_addsub_fin.sh -help'.
