...
HD_PWD='C:/Users/Krasnal/Desktop/Wegrzyn/lab7/vis_circle/vis_circle.runs/c_addsub_fin_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log c_addsub_fin.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source c_addsub_fin.tcl
