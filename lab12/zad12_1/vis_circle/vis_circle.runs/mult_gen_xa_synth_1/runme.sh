...
HD_PWD='C:/Users/Krasnal/Desktop/Wegrzyn/lab7/vis_circle/vis_circle.runs/mult_gen_xa_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mult_gen_xa.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mult_gen_xa.tcl
