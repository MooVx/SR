...
module hdmi_vga
  ...
  wire sys_clock_1;
  wire vp_bin_0_de_out;
  wire vp_bin_0_h_sync_out;
  wire [23:0]vp_bin_0_pixel_out;
  wire vp_bin_0_v_sync_out;
  ...
  hdmi_vga_rgb2vga_0_0 rgb2vga_0
       (.PixelClk(dvi2rgb_1_PixelClk),
        ...
        .rgb_pVSync(vp_bin_0_v_sync_out),
  ...
  hdmi_vga_vp_bin_0_0 vp_bin_0
       (.clk(dvi2rgb_1_PixelClk),
        ...
        .h_sync_out(vp_bin_0_h_sync_out),
        .pixel_in(dvi2rgb_1_vid_pData),
        .pixel_out(vp_bin_0_pixel_out),
        .v_sync_in(dvi2rgb_1_vid_pVSync),
        .v_sync_out(vp_bin_0_v_sync_out));
endmodule
