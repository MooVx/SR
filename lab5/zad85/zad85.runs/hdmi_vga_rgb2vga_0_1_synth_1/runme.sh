...
HD_PWD='/home/lsriw/sr/RomanMichal/SR/lab5/zad85/zad85.runs/hdmi_vga_rgb2vga_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_vga_rgb2vga_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hdmi_vga_rgb2vga_0_1.tcl
