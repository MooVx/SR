...
HD_PWD='/home/lsriw/sr/RomanMichal/SR/lab5/zad83/zad83.runs/hdmi_vga_xlconstant_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_vga_xlconstant_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hdmi_vga_xlconstant_1_0.tcl
