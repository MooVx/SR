...
HD_PWD='/home/lsriw/sr/RomanMichal/SR/lab5/vp_bin/vp_bin.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vp_bin.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vp_bin.tcl -notrace
