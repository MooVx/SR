...
HD_PWD='/home/lsriw/sr/RomanMichal/SR/lab5/vp_bin/vp_bin.runs/g_lut_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log g_lut.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source g_lut.tcl
