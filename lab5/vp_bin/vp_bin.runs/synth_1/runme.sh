...
HD_PWD='/home/lsriw/sr/RomanMichal/SR/lab5/vp_bin/vp_bin.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vp_bin.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vp_bin.tcl
