...
#
# Generated by export_simulation on Tue Apr 24 14:25:14 +0200 2018
#
################################################################################
...
'-reset_run' switch to the './b_lut.sh' script.
...
./b_lut.sh -noclean_files

For more information on the script, please type './b_lut.sh -help'.
