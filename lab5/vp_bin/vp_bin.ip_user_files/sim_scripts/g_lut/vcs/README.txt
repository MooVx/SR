...
#
# Generated by export_simulation on Tue May 08 18:27:36 +0200 2018
#
################################################################################
...
'-reset_run' switch to the './g_lut.sh' script.
...
./g_lut.sh -noclean_files

For more information on the script, please type './g_lut.sh -help'.
