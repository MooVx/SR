...
#
# Generated by export_simulation on Tue May 08 18:27:12 +0200 2018
#
################################################################################
...
'-reset_run' switch to the './r_lut.sh' script.
...
./r_lut.sh -noclean_files

For more information on the script, please type './r_lut.sh -help'.
