...
HD_PWD='C:/Users/Krasnal/Desktop/Wegrzyn/lab7/vis_circle/vis_circle.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vis_circle.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vis_circle.tcl
