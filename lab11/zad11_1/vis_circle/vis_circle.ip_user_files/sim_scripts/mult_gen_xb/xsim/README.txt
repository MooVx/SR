...
#
# Generated by export_simulation on Wed May 23 23:41:09 +0200 2018
#
################################################################################
...
'-reset_run' switch to the './mult_gen_xb.sh' script.

./mult_gen_xb.sh -reset_run
...
./mult_gen_xb.sh -noclean_files

For more information on the script, please type './mult_gen_xb.sh -help'.
