...
HD_PWD='C:/git/SR/lab10/zad10_6/vp/vp.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vp.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vp.tcl -notrace
