...
#
# Generated by export_simulation on Sun May 20 18:35:29 +0200 2018
#
################################################################################
...
'-reset_run' switch to the './acc_m01.sh' script.

./acc_m01.sh -reset_run
...
./acc_m01.sh -noclean_files

For more information on the script, please type './acc_m01.sh -help'.
