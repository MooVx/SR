...
#
# Generated by export_simulation on Sun May 20 18:35:50 +0200 2018
#
################################################################################
...
'-reset_run' switch to the './acc_m10.sh' script.

./acc_m10.sh -reset_run
...
./acc_m10.sh -noclean_files

For more information on the script, please type './acc_m10.sh -help'.
