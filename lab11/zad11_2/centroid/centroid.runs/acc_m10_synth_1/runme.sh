...
HD_PWD='C:/git/SR/lab11/zad11_1/centroid/centroid.runs/acc_m10_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log acc_m10.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source acc_m10.tcl
