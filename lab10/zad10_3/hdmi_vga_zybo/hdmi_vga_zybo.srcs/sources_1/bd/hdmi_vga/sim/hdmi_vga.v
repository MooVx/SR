...
module hdmi_vga
  ...
  wire rgb2ycbcr_0_hsync_out;
  wire [23:0]rgb2ycbcr_0_pixel_out;
  wire rgb2ycbcr_0_vsync_out;
  wire sys_clock_1;
  ...
  hdmi_vga_rgb2vga_1_0 rgb2vga_1
       (.PixelClk(dvi2rgb_0_PixelClk),
        ...
        .rgb_pHSync(rgb2ycbcr_0_hsync_out),
        .rgb_pVDE(rgb2ycbcr_0_de_out),
        .rgb_pVSync(rgb2ycbcr_0_vsync_out),
  ...
  hdmi_vga_rgb2ycbcr_0_0 rgb2ycbcr_0
       (.clk(dvi2rgb_1_aPixelClkLckd),
        .de(dvi2rgb_1_vid_pVDE),
        .de_out(rgb2ycbcr_0_de_out),
        .hsync(dvi2rgb_1_vid_pHSync),
        .hsync_out(rgb2ycbcr_0_hsync_out),
        .pixel_in(dvi2rgb_1_vid_pData),
        .pixel_out(rgb2ycbcr_0_pixel_out),
        .vsync(dvi2rgb_1_vid_pVSync),
        .vsync_out(rgb2ycbcr_0_vsync_out));
endmodule
