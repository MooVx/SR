...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net dvi2rgb_0_PixelClk [get_bd_pins dvi2rgb_1/PixelClk] [get_bd_pins rgb2vga_1/PixelClk]
  connect_bd_net -net dvi2rgb_1_aPixelClkLckd [get_bd_pins dvi2rgb_1/aPixelClkLckd] [get_bd_pins rgb2ycbcr_0/clk]
  connect_bd_net -net dvi2rgb_1_vid_pData [get_bd_pins dvi2rgb_1/vid_pData] [get_bd_pins rgb2ycbcr_0/pixel_in]
  connect_bd_net -net dvi2rgb_1_vid_pHSync [get_bd_pins dvi2rgb_1/vid_pHSync] [get_bd_pins rgb2ycbcr_0/hsync]
  connect_bd_net -net dvi2rgb_1_vid_pVDE [get_bd_pins dvi2rgb_1/vid_pVDE] [get_bd_pins rgb2ycbcr_0/de]
  connect_bd_net -net dvi2rgb_1_vid_pVSync [get_bd_pins dvi2rgb_1/vid_pVSync] [get_bd_pins rgb2ycbcr_0/vsync]
  ...
  connect_bd_net -net rgb2ycbcr_0_de_out [get_bd_pins rgb2vga_1/rgb_pVDE] [get_bd_pins rgb2ycbcr_0/de_out]
  connect_bd_net -net rgb2ycbcr_0_hsync_out [get_bd_pins rgb2vga_1/rgb_pHSync] [get_bd_pins rgb2ycbcr_0/hsync_out]
  connect_bd_net -net rgb2ycbcr_0_pixel_out [get_bd_pins rgb2vga_1/rgb_pData] [get_bd_pins rgb2ycbcr_0/pixel_out]
  connect_bd_net -net rgb2ycbcr_0_vsync_out [get_bd_pins rgb2vga_1/rgb_pVSync] [get_bd_pins rgb2ycbcr_0/vsync_out]
