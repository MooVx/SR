...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net dvi2rgb_1_PixelClk [get_bd_pins dvi2rgb_1/PixelClk] [get_bd_pins rgb2vga_0/PixelClk] [get_bd_pins vp_bin_0/clk]
  connect_bd_net -net dvi2rgb_1_vid_pData [get_bd_pins dvi2rgb_1/vid_pData] [get_bd_pins vp_bin_0/pixel_in]
  connect_bd_net -net dvi2rgb_1_vid_pHSync [get_bd_pins dvi2rgb_1/vid_pHSync] [get_bd_pins vp_bin_0/h_sync_in]
  connect_bd_net -net dvi2rgb_1_vid_pVDE [get_bd_pins dvi2rgb_1/vid_pVDE] [get_bd_pins vp_bin_0/de_in]
  connect_bd_net -net dvi2rgb_1_vid_pVSync [get_bd_pins dvi2rgb_1/vid_pVSync] [get_bd_pins vp_bin_0/v_sync_in]
