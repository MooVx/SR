...
HD_PWD='C:/git/SR/lab08/zad85/zad85.runs/hdmi_vga_vp_bin_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_vga_vp_bin_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hdmi_vga_vp_bin_0_0.tcl
