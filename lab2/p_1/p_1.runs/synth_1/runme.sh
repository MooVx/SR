...
HD_PWD='C:/Drive/S6/SR/RomanMichal/lab2/p_1/p_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log longand.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source longand.tcl
